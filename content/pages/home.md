...
[Looking for a different mesh in Pennsylvania?](https://pame.sh)
...
We build our mesh using low-power, long-range radio hardware, enabling communication across distances that traditional technologies like Wi-Fi or Bluetooth cannot reach. Our network is powered by the Meshtastic and MeshCore open-source projects, which do _not_ require an amateur radio license to use.
